...
export type SettingsTab = 'general' | 'channels' | 'vision-relay' | 'proxy' | 'appearance' | 'about' | 'onboarding' | 'prompts' | 'agent-roles' | 'bots' | 'shortcuts' | 'voice-input' | 'migration' | 'storage'
