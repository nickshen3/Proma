    ...
    sdk.defineTool({
      ...
      async execute(_toolCallId, params) {
        ...
        const record = await executeAgentTerminal({
          ...
          command,
          terminalId,
          fallbackToDefaultProfile: usingRememberedProfile,
